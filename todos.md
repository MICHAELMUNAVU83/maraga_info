...
- [x] Freeze the Campaign Pillars page — it should have nothing

## Press — Press Statements

- [x] Remove the green preview added on each document
- [x] Change layout from boxes to a descending list of statements, with the last word hyperlinked to open the full article
  - e.g. "Statement on Ebola", "Statement on Criticism of the current government", "Statement on Water is a health right"
- [x] Reduce font size on Press Statement titles (e.g. 10 → ~7)
- [x] Remove the "Full Story" headline from every press release and all published news
- [ ] Change the picture on the press release tab
...
- [ ] Halve the size of the current image (green and yellow area) so it ends just under the Read More and Join the Movement buttons
- [ ] Fade the green and yellow so the background carousel images are clearer
