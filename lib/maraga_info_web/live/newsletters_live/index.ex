defmodule MaragaInfoWeb.NewslettersLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok,
     socket
     |> assign(:page_title, "Newsletters | #{Seo.site_name()}")
     |> assign(
       :page_description,
       "Read the latest newsletters from David Maraga's 2027 campaign."
     )
     |> assign(:canonical_url, Seo.site_url() <> "/newsletters")
     |> assign(:posts, Content.list_published_newsletters())}
  end
        ...
        <div class="mx-auto max-w-container px-4">
          <div class="mb-10 flex flex-wrap items-center justify-between gap-4">
            <h2 class="font-head text-2xl uppercase tracking-[0.08em] text-blueink">
              All <span class="text-crimson">Newsletters</span>
            </h2>
          </div>
          ...
          >
            <h3 class="font-head text-2xl uppercase tracking-[0.08em] text-blueink">
              No newsletters here yet
            </h3>
            <p class="mx-auto mt-3 max-w-xl text-base leading-7 text-grayink">
              Posts published under the "Newsletter" category will appear here automatically.
            </p>
          </div>
